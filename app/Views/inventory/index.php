            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <a href="<?= site_url('inventory/create') ?>"
                           class="btn btn-success font-weight-semibold">
                            Add Inventory
                        </a>

                        <a href="<?= site_url('inventory/export') ?>"
                           class="btn btn-success font-weight-semibold">
                            Export Excel
                        </a>
                        ...
                        <tbody id="inventoryTableBody">
                            ...
                            <?php foreach ($inventory as $item): ?>
                                ...
                                <tr>
                                  ...
                                  <a href="<?= site_url('inventory/edit/' . $item['id']) ?>" class="btn btn-warning btn-xs">Edit</a>
                                  <a href="<?= site_url('inventory/delete/' . $item['id']) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Delete this record?')">Delete</a>
                                    </td>
            ...
            response.data.forEach(function (item) {
                ...
                tableBody.innerHTML += `
                    ...
                    <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-info btn-sm btn-view" data-id="${item.id}"> View </button>
                            <a href="<?= site_url('inventory/edit') ?>/${item.id}" class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?= site_url('inventory/delete/' . $item['id']) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Delete this record?')">Delete</a>
                        </td>
...
document.addEventListener('click', function (event) {
    ...
    fetch("<?= site_url('inventory/view') ?>/" + id)
