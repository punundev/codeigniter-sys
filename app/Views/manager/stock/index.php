...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3 d-flex flex-wrap" style="gap: 4px;">
            <a href="<?= site_url('manager/stock/create') ?>"
              class="btn btn-primary btn-sm">
                Add Stock
            </a>

            <a href="<?= site_url('manager/stock/stock-in') ?>"
             class="btn btn-primary btn-sm">
                Stock In
            </a>

            <a href="<?= site_url('manager/stock/stock-out') ?>"
               class="btn btn-primary btn-sm">
                Stock Out
            </a>

            <a href="<?= site_url('manager/stock/reports') ?>"
               class="btn btn-primary btn-sm">
                View Reports
            </a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex" style="gap: 4px;">
                                    <a href="<?= site_url('manager/stock/edit/' . $item['id']) ?>"
                                       class="btn btn-warning btn-sm">
                                        Edit
                                    </a>

                                    <a href="<?= site_url('manager/stock/delete/' . $item['id']) ?>"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadStock() {
        ...
        fetch(
            "<?= site_url('manager/stock/ajaxFilter') ?>?" +
            params.toString()
        )
