    ...
    <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <a href="<?= site_url('staff/inventory/create') ?>"
                           class="btn btn-success font-weight-semibold">
                            Add Inventory
                        </a>

                        <a href="<?= site_url('staff/inventory/export') ?>"
                           class="btn btn-success font-weight-semibold">
                            Export Excel
                        </a>
                    ...
                    <div>
                        ...
                        <form method="get"
                              action="<?= site_url('staff/inventory') ?>"
                              class="d-flex">
        ...
        <?php endforeach; ?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-1">
                        ...
                        <a href="<?= site_url('staff/inventory') ?>"
                        ...
                        <tbody id="inventoryTableBody">
                            ...
                            <?php foreach ($inventory as $item): ?>
                                ...
                                <tr>
                                  ...
                                  <a href="<?= site_url('staff/inventory/edit/' . $item['id']) ?>" class="btn btn-warning btn-xs">Edit</a>
                                  <a href="<?= site_url('staff/inventory/delete/' . $item['id']) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Delete this record?')">Delete</a>
                                    </td>
    ...
    */
    ...
    function loadInventory() {
       ...
       const manufacturer = document.getElementById('manufacturerFilter').value;
        ...
        const url =
            "<?= site_url('staff/inventory/ajaxFilter') ?>" +
            ...
            response.data.forEach(function (item) {
                ...
                tableBody.innerHTML += `
                    ...
                    <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-info btn-sm btn-view" data-id="${item.id}"> View </button>
                            <a href="<?= site_url('staff/inventory/edit') ?>/${item.id}" class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?= site_url('staff/inventory/delete/' . $item['id']) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Delete this record?')">Delete</a>
                        </td>
...
document.addEventListener('click', function (event) {
    ...
    fetch("<?= site_url('staff/inventory/view') ?>/" + id)
