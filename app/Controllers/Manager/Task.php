...
class Task extends BaseController
{
    ...
    public function store()
    {
        ...
        return redirect()->to(
            site_url('manager/task/view/' . $task_id)
    ...
    public function update($id)
    {
        ...
        if (!$task) {
            return redirect()->to(site_url('manager/task'))
    ...
    public function report()
    {
        ...
        return view('manager/task/report', $data);
    }
